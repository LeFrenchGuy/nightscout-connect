        ...
        .then(function (data) {
          if (!data) {
            ...
            if (username && password) {
              log.info('[OAuth] No tokens in MongoDB, attempting automated login with credentials...');
              ...
              return auth.discoverAuth0Config(isUS, axios)
                .then(function (config) {
                  ...
                  return auth.loginAutomated(config.ssoConfig, config.baseUrl, pkce.codeChallenge, username, password, axios)
                    ...
                    .then(function (loginData) {
                      log.info('[OAuth] Automated login successful, saving tokens to MongoDB...');
                ...
                .catch(function (error) {
                  log.warn('[OAuth] Automated login failed:', error.message);
